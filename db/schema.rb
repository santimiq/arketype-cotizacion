...
ActiveRecord::Schema.define(version: 2020_02_13_181715) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "concept_quotations", force: :cascade do |t|
    t.string "concepto"
    t.bigint "quotation_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["quotation_id"], name: "index_concept_quotations_on_quotation_id"
  end
  ...
  add_foreign_key "concept_quotations", "quotations"
